    ...
    return (
        <div>
            {isLoading ? ( // Show loading screen if isLoading is true
                ...
                >
                    <section
                        class="h-screen w-screen flex flex-col items-center justify-center opacity-0 ease-in duration-100 mt-10"
                        id="section"
                    >
                            ...
                            <a href="https://drive.google.com/file/d/1eVv3tqRd2OFzfrfcBLTgkzqfkKx_Ue7p/view?usp=sharing">
                                ...
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24"
                                        class="h-4 w-4 mr-2 fill-current text-gray-600"
                                    >
                                        <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                    ...
                    <div className=" px-6 mx-auto m-3 space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-10">
                        <div class="grid grid-cols-1 gap-4 mx-auto  lg:mx-0 md:grid-cols-3 ">
                            <div class="grid grid-cols-1 gap-4">
                                <div class="bg-gradient-to-r  bg-blue-900 hover:bg-blue-800 rounded-lg px-4 py-6 text-center">
                                    <div class="mb-3">
