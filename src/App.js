    ...
    <div>
      {isLoading ? ( // Show loading screen if isLoading is true
        ...
        <div style={{ width: '100%', height: '100%', background: '#000011' }}>
          <Parallax pages={3} ref={parallax} style={{ background: '#000020' }}>
            ...
            <ParallaxLayer offset={1} speed={0.3} style={{ backgroundColor: '#000020' }}>
              <h1 class="text-center text-5xl font-bold text-white">Timeline</h1>
              <Timeline />
            </ParallaxLayer>
            
            <ParallaxLayer offset={2} speed={0.8} style={{ backgroundColor: '#000030' }}></ParallaxLayer>
            <ParallaxLayer
              offset={0}
              speed={0}
              factor={3}
            ...
            <ParallaxLayer offset={1} speed={0.8} style={{ opacity: 0.1 }}>
              ...
              <img alt='' src={url('cloud')} style={{ opacity:40, display: 'block', width: '10%', marginLeft: '15%' }} />
            </ParallaxLayer>
            <ParallaxLayer offset={1.90} speed={0.5} style={{ opacity: 0.1 }}>
            ...
            <ParallaxLayer offset={1.6} speed={-0.1} style={{ opacity: 0.4 }}>
              ...
              <img alt='' src={url('cloud')} style={{ opacity:40, display: 'block', width: '10%', marginLeft: '80%' }} />
            </ParallaxLayer>
