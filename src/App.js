  ...
  const data = [
    {
      ...
      subtitle: "National University of Sciences and Technology (FAST-NUCES)",
    ...
    <div>
      {isLoading ? (
        ...
        <div
          ...
          className="transition duration-1300 ease-in-out flex flex-col m-5"
        >
          <section
          ...
          <section className="skills flex flex-col h-screen md:h-screen ml-5 md:ml-10 mt-5 md:mt-10 max-[800px]:scale-75">
          
          </section>

          <section className="flex flex-col max-[800px]:scale-75 w-screen h-screen ">
