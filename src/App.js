        ...
        <div>
            {isLoading ? (
                ...
                >
                        ...
                        <div className="flex flex-col ">
                            ...
                            <div className="grid grid-cols-2">
                                <div className="dev flex flex-col">
                                    <h2 className="text-3xl font-bold text-white mt-5">Development</h2>
                                    <div className="devs_things grid grid-cols-3">
                                        {development.map((item) => (
                                            <div
                                                key={item.id}
                                                className="flex items-center align-middle justify-center m-3 bg-gradient-to-r bg-[#1b1b1b] rounded-full w-28 h-28 text-center"
                                            >
                                                <div className="mb-3">
                                                    <h2 className="text-xl font-thin text-gray-200">
                                                        {item.item}
                                                    </h2>
                                                </div>
                                            </div>
                                ...
                                <div className="tools flex flex-col">
                                    <h2 className="text-3xl font-bold text-white mt-5">Tools</h2>
                                </div>
                            </div>
                            <div className="grid grid-cols-2">
                                <div className="dev flex flex-col">
                                    {/* <h2 className="text-3xl font-bold text-white mt-5">Frameworks</h2>
                                    <div className="devs_things grid grid-cols-3">
                                        {development.map((item) => (
                                            <div
                                                key={item.id}
                                ...
                                <div className="tools flex flex-col">
                                    <h2 className="text-3xl font-bold text-white mt-5">Workflow</h2>
                                </div> */}
                                </div>
                            </div>
                        </div>
                    ...
                    <section className="skills flex flex-col items-center  w-screen h-screen max-[400px]:scale-75 lg:scale-100">
                        <h1 className="text-center text-5xl font-bold text-white">
                            Projects
                        </h1>
                        <Projects />
