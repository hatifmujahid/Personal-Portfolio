export default function Card() {
    return (
        <div class="overflow-hidden relative duration-700 border rounded-xl hover:bg-zinc-800/10 group md:gap-8 hover:border-zinc-400/50 border-zinc-600">
                ...
                <article class="p-4 md:p-8">
                  <div class="flex justify-between gap-2 items-center">
                    <span class="text-xs duration-1000 text-zinc-200 group-hover:text-white group-hover:border-zinc-200 drop-shadow-orange">
                      <time datetime="2023-05-21T00:00:00.000Z">May 21, 2023</time>
                    </span>
                  ...
                  <h2 class="z-20 text-xl font-medium duration-1000 lg:text-3xl text-zinc-200 group-hover:text-white font-display">Zod Bird</h2>
                  <p class="z-20 mt-4 text-sm  duration-1000 text-zinc-400 group-hover:text-zinc-200">Zodbird is an e2e typed tinybird.co client library for typescript, leveraging zod for type safety and transformations</p>
                </article>
              </a>
            </div>
    )
